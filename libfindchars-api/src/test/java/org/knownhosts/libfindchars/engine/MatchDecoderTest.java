...
class MatchDecoderTest {
	...
	void testDecodeVecMemorySegmentsInt() {
		List<Integer> countsVector = new ArrayList<>();
		List<Integer> countsScalar = new ArrayList<>();

		byte[] testbits = new byte[] {0xf,0xf,0x0,0xf,0x0,0x0,0xf,0x0,0xf,0xf,0x0,0xf,0x0,0x0,0xf,0x0,0xf,0xf,0x0,0xf,0x0,0x0,0xf,0x0,0xf,0xf,0x0,0xf,0x0,0x0,0xf,0x0};
