...
public class FindCharsEngine {
    ...
    void initialize() {
        ...
        lowNibbleMasks_1[0] = ByteVector.fromArray(ByteVector.SPECIES_PREFERRED,
            Arrays.copyOf(new byte[]{-61,-70,-70,-69,-70,-103,-102,-102,-70,69,79,103,91,87,-70,-101},ByteVector.SPECIES_PREFERRED.vectorByteSize()), 0);

        highNibbleMasks_1[0] = ByteVector.fromArray(ByteVector.SPECIES_PREFERRED,
            Arrays.copyOf(new byte[]{-31,-102,125,87,-102,-49,-102,-49}, ByteVector.SPECIES_PREFERRED.vectorByteSize()), 0);
        ...
        lowNibbleMasks_1[1] = ByteVector.fromArray(ByteVector.SPECIES_PREFERRED,
            Arrays.copyOf(new byte[]{126,126,126,126,126,126,126,126,126,126,-127,-127,-127,-127,-127,-127},ByteVector.SPECIES_PREFERRED.vectorByteSize()), 0);

        highNibbleMasks_1[1] = ByteVector.fromArray(ByteVector.SPECIES_PREFERRED,
            Arrays.copyOf(new byte[]{-127,-127,-127,-1,-127,-127,-127,-127}, ByteVector.SPECIES_PREFERRED.vectorByteSize()), 0);
        ...
        this.literal_2 = ByteVector.SPECIES_PREFERRED.broadcast(99).reinterpretAsBytes();
    }
